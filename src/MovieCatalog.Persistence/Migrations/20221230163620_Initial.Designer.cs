...
namespace MovieCatalog.Persistence.Migrations
{
    ...
    [Migration("20221230163620_Initial")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("GenreMovie", b =>
                {
                    b.HasOne("MovieCatalog.Domain.Models.Genre", null)
                        .WithMany()
            ...
            modelBuilder.Entity("MovieCatalog.Domain.Models.Movie", b =>
                {
                    b.HasOne("MovieCatalog.Domain.Models.Person", "Director")
                        .WithMany("Directions")
            ...
            modelBuilder.Entity("MoviePerson", b =>
                {
                    ...
                    b.HasOne("MovieCatalog.Domain.Models.Person", null)
                        .WithMany()
