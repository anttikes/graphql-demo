...
/// </summary>
internal class GenresConverter : ValueConverter<HashSet<string>, string>
{
    public GenresConverter() : base(
        value => JsonSerializer.Serialize(value, new JsonSerializerOptions(JsonSerializerDefaults.Web)),
        value => JsonSerializer.Deserialize<HashSet<string>>(value, new JsonSerializerOptions(JsonSerializerDefaults.Web))!)
    {
    }
}
